...
class OpenAIProvider():
    ...
    def __init__(self, model: str = LLM.DEFAULT_MODEL):
        ...
        if not self.api_key:
            ...
            raise ValueError(Constants.ERROR_MISSING_API_KEY)
        ...
        try:
            ...
            while True:
                ...
                if not response.choices:
                    raise LLMGenerationError(Constants.ERROR_NO_CHOICES)
                    ...
                    for tool_call in message.tool_calls:
                        ...
                        if func_name in tool_map:
                            ...
                            try:
                                ...
                                tool_result = Constants.ERROR_TOOL_EXECUTION.format(e=e)
                        else:
                            tool_result = Constants.ERROR_TOOL_NOT_FOUND.format(func_name=func_name)
            ...
            raise LLMConnectionError(Constants.ERROR_API_CONNECTION.format(e=e))
        except OpenAIError as e:
            logger.error(f"OpenAI API Error: {e}")
            raise LLMGenerationError(Constants.ERROR_API_GENERATION.format(e=e))
        except Exception as e:
            logger.exception("Unexpected error during OpenAI generation.")
            raise LLMGenerationError(Constants.ERROR_UNEXPECTED.format(e=e))
